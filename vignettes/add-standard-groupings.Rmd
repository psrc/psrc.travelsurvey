...
| **`hts_bin_mode()`**             | mode_class       | mode_basic                        | Walk/Bike/Micromobility • Transit • Carpool • Drive alone|
| **`hts_bin_transit_acc_mode()`** | mode_acc, mode_class| transit_mode_acc                   | Walked or jogged • Bike/Micromobility • Vehicular |
|                                  |                  |                                       |                                            |
