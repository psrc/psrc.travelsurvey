...
vignette: >
  %\VignetteIndexEntry{1: Retrieve and summarize data}
...
library(magrittr)
```
## **travelSurveyTools** & **psrc.travelsurvey** packages work together
...
rs1 <- psrc_hts_stat(hts_data, analysis_unit="trip", group_vars="hhsize", stat_var="duration_minutes")
head(rs1)

# Calculate a categorical summary, i.e. count/share
rs2 <- psrc_hts_stat(hts_data, analysis_unit="trip", group_vars=c("hhsize", "mode_characterization"))
head(rs2)
